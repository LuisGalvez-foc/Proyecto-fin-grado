...
<body>
    ...
    <div class="container">
        ...
        <select name="producto" id="selectCategoria">
            <option class="opcion">Seleccione Artículo</option>
            <?php 
            $sql_categoria = "SELECT categoria FROM categoria";
        ...
        <div class="resultados">
            <table>
                <tr>
                    <td class="art">Art.</td>
                    <td class="campos">Categoría</td>
                    <td class="campos">Modelo</td>
                    <td class="campos">Color</td>
                    <td class="">Talle</td>
                    <td class="">Cantidad</td>
                </tr>
                <tbody id="data_recuperada"></tbody>
            </table> 
        </div>
    ...
    <script>
        ...
        infoGeneral.innerHTML = "Mensaje de la página consulta de stock. No lleva password.";
